describe('User Registration and Login', () => {
    ...
    it('Should register as an Recruiter', () => {
...
it('Should register as an exists Recruiter', () => {
    cy.visit('https://www.qualifiedcrew.com/register/account-type');
    cy.get('.css-grry9j:nth-child(2) .css-h1jf7p').click();
    cy.get('input[name="name"]').type('Naseer');
    cy.get('#root').type("naseerob74@gmail.com")
    cy.get('input[name="password"]').type('Admin@123');
    cy.get('input[name="policy"]').click()
    cy.get('button[type="submit"]').click();
});
...
it('Should register as an invalid  formate email', () => {
    cy.visit('https://www.qualifiedcrew.com/register/account-type');
    cy.get('.css-grry9j:nth-child(2) .css-h1jf7p').click();
    cy.get('input[name="name"]').type('Sara rode');
